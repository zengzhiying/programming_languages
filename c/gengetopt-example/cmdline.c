...
const char *gengetopt_args_info_purpose = "Gengetopt use example.";

const char *gengetopt_args_info_usage = "Usage: example usage: ";

const char *gengetopt_args_info_versiontext = "version: 1.0.0";

const char *gengetopt_args_info_description = "This Gengetopt example.";

const char *gengetopt_args_info_help[] = {
  "      --help          Print help and exit",
  "  -V, --version       Print version and exit",
  "  -h, --host=STRING   Socket host.",
  "  -p, --port=INT      Socket port.",
  "  -c, --conf=STRING   Config file.  (default=`/etc/gengetopt.conf')",
  "      --log           Whether to open the log.  (default=off)",
  "  -P, --parallel=INT  Parallelism.  (default=`4')",
  "      --num=INT       Data num.",
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->conf_arg = gengetopt_strdup ("/etc/gengetopt.conf");
  args_info->conf_orig = NULL;
  args_info->log_flag = 0;
  args_info->parallel_arg = 4;
  args_info->parallel_orig = NULL;
  args_info->num_arg = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->parallel_help = gengetopt_args_info_help[6] ;
  args_info->num_help = gengetopt_args_info_help[7] ;
  args_info->num_min = 0;
  args_info->num_max = 0;
  args_info->value_help = gengetopt_args_info_help[8] ;
  args_info->value_min = 0;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->parallel_orig));
  free_multiple_field (args_info->num_given, (void *)(args_info->num_arg), &(args_info->num_orig));
  args_info->num_arg = 0;
  free_multiple_string_field (args_info->value_given, &(args_info->value_arg), &(args_info->value_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->parallel_given)
    write_into_file(outfile, "parallel", args_info->parallel_orig, 0);
  write_multiple_into_file(outfile, args_info->num_given, "num", args_info->num_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (check_multiple_option_occurrences(prog_name, args_info->num_given, args_info->num_min, args_info->num_max, "'--num'"))
     error_occurred = 1;
  
  if (check_multiple_option_occurrences(prog_name, args_info->value_given, args_info->value_min, args_info->value_max, "'--value'"))
     error_occurred = 1;
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  struct generic_list * num_list = NULL;
  struct generic_list * value_list = NULL;
  int error_occurred = 0;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "Vh:p:c:P:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'c':	/* Config file..  */
          ...
          if (update_arg( (void *)&(args_info->conf_arg), 
              ...
              &(local_args_info.conf_given), optarg, 0, "/etc/gengetopt.conf", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "conf", 'c',
              additional_error))
            goto failure;
        ...
        case 'P':	/* Parallelism..  */
          ...
          if (update_arg( (void *)&(args_info->parallel_arg), 
               &(args_info->parallel_orig), &(args_info->parallel_given),
              &(local_args_info.parallel_given), optarg, 0, "4", ARG_INT,
              check_ambiguity, override, 0, 0,
              "parallel", 'P',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "log") == 0)
          {
            ...
            if (update_arg((void *)&(args_info->log_flag), 0, &(args_info->log_given),
                ...
                check_ambiguity, override, 1, 0, "log", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "num") == 0)
          {
            ...
            if (update_multiple_arg_temp(&num_list, 
          ...
          else if (strcmp (long_options[option_index].name, "value") == 0)
          {
            ...
            if (update_multiple_arg_temp(&value_list, 
  ...
  update_multiple_arg((void *)&(args_info->num_arg),
    &(args_info->num_orig), args_info->num_given,
    local_args_info.num_given, 0,
    ARG_INT, num_list);
  update_multiple_arg((void *)&(args_info->value_arg),
    &(args_info->value_orig), args_info->value_given,
    local_args_info.value_given, 0,
    ARG_STRING, value_list);

  args_info->num_given += local_args_info.num_given;
  local_args_info.num_given = 0;
  args_info->value_given += local_args_info.value_given;
  local_args_info.value_given = 0;
...
failure:
  free_list (num_list, 0 );
  free_list (value_list, 1 );
