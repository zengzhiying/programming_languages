...
<%@page import="net.zengzhiying.beans.Logs"%>
...
<div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl"><strong class="am-text-primary am-text-lg">系统操作日志查看</strong> / <small>Action Log</small></div>
      </div>
      ...
      <div class="am-g error-log">
        ...
        <%
        List<Object> logsList = (List<Object>) request.getAttribute("logsList");
        if(logsList.size() > 0) {
        	for(Object obj:logsList) {
        		Logs l = (Logs) obj;
        	%>
        	<span class="am-text-success">[<%=(new DataTypeConver().timeToString(l.getLog_time(), "yyyy-MM-dd  HH:mm:ss")) %>]</span> <span class="am-text-danger">[<%=l.getLog_type() %>]</span> <%=l.getLog_describe() %>
        	<%
        	}
        }
        %>
