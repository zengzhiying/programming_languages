...
<head>
  ...
  <title>抱歉，您无权访问此页面</title>
  <meta name="description" content="这是一个错误页面">
  <meta name="keywords" content="405,500">
...
<body>
<!--[if lte IE 9]>
<p class="browsehappy">你正在使用<strong>过时</strong>的浏览器，管理系统 暂不支持。 请 <a href="http://chrome.360.com/" target="_blank">升级360极速浏览器</a>
  以获得更好的体验！</p>
<![endif]-->

<header class="am-topbar am-topbar-inverse admin-header">
  <div class="am-topbar-brand">
    <strong>企业员工上线</strong> <small> 管理系统</small>
  </div>
...
<div class="am-cf admin-main">
    ...
    <div class="admin-content-body">
      ...
      <div class="am-g">
        <div class="am-u-sm-12">
          <h2 class="am-text-center am-text-xxxl am-margin-top-lg">非常抱歉，您无权访问本页面！</h2>
          <p class="am-text-center">3s后将返回登录页面</p>
        <pre class="page-404">
          .----.
       _.'__    `.
   .--($)($$)---/#\
 ...
 :         ,   #####
  ...
  function jump() {
	  //直接退出
	  window.location.href="<%=pagePath %>/webadmin/logout";
  }
  </script>
</div>
